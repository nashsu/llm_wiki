/**
 * Regression suite for Save-to-Wiki filename generation (server-side port of
 * src/lib/wiki-filename.test.ts for issue #14's server-driven ingest). The
 * bug being pinned: the previous ASCII-only slug regex made every CJK-titled
 * conversation collapse to an empty slug, colliding all same-day saves into a
 * single `-YYYY-MM-DD.md`. These tests pin the policy.
 */
import { describe, it, expect } from "vitest"
import { makeQuerySlug, makeQueryFileName } from "../src/ingest/wiki-filename.js"
