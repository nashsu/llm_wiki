...
[Releases](https://github.com/slowtokki0409/llm-wiki-app/releases)에서 다운로드합니다.
...
`--dry-run`을 빼면 live smoke가 실행됩니다. 이 명령은 runtime proof 파일을 쓰고 source/context 내용을 설정된 LLM provider로 보내므로, 명시적인 운영 판단이 있을 때만 실행합니다.
