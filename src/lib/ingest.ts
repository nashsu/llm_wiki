...
import {
  extractUnclosedFileBlockAttempts,
  parseFileBlocks,
  type ParsedFileBlock,
} from "@/lib/ingest/file-blocks"
import {
  PDF_SOURCE_SUMMARY_SECTIONS,
  formatPdfStructureForPrompt,
  isPdfSourceFile,
  isStrongPdfPromotionCandidate,
  parsePdfPromotionCandidates,
  pdfTraceIsUsable,
  roleForPdfCandidate,
  type PdfPromotionCandidate,
} from "@/lib/ingest/pdf"
...
export type { ParsedFileBlock, ParseFileBlocksResult } from "@/lib/ingest/file-blocks"
export {
...
export type { PdfPromotionCandidate, PdfStructureSummary } from "@/lib/ingest/pdf"
