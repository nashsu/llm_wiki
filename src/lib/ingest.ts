...
export function buildGenerationPrompt(
  ...
  return [
    ...
    "",
    "For missing-page reviews, the Title MUST be exactly the missing entity/concept name(s) and nothing else.",
    "If several entities are missing, list their names in the Title separated by '、' (e.g. 'CallMethod、StartFunc、Print').",
    "Do NOT phrase the Title as a sentence. PAGES must list the EXISTING pages that reference the gap (not the pages to create).",
    "",
...
function buildReviewSuggestionPrompt(
  ...
  return [
    ...
    "  The Title MUST be exactly the missing entity/concept name(s), nothing else; list multiple",
    "  names separated by '、' (e.g. 'CallMethod、StartFunc、Print'). PAGES lists the EXISTING pages",
    "  that reference the gap, not the pages to create.",
