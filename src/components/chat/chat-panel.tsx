      ...
      if (project && greetingOnly) {
        ...
        systemMessages.push({
          ...
          content: [
            ...
            "",
            "## Images",
            "- The wiki pages below may contain markdown images like `![](media/slug/img-1.png)` or `![](../media/slug/img-1.png)`.",
            "- These images render INLINE in this chat interface. You CAN show images — you are NOT a text-only assistant.",
            "- When an image on a cited page is relevant to your answer, reproduce its markdown tag VERBATIM (keep the exact `![](...)` path from the page) so it displays inline.",
            "- Never describe an image as a file path the user must open manually, and never claim you cannot display images. Just emit the `![](...)` markdown.",
            "",
